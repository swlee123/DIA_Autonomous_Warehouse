...
def main():
    ...
    print(f"\n--- Testing {ALGORITHM} in Environment: Preset1 ---")
    ...
    reward, rpt, collision, cpt = run_warehouse_with(
            ...
            TICKS,
            INTERVAL,
            ENVIRONMENTS["shelf_column"],
            ENVIRONMENTS["column_height"],
            ENVIRONMENTS["shelf_rows"],
            ENVIRONMENTS["agent_count"],
            ENVIRONMENTS["human_count"],
